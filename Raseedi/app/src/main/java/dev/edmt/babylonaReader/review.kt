...
class review : AppCompatActivity() {
    ...
    class PlaceholderFragment : Fragment() {
        ...
        override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
            ...
            rootView.section_labell.text = getString(R.string.section_format, arguments.getInt(ARG_SECTION_NUMBER))

            img="sec"+arguments.getInt(dev.edmt.androidcamerarecognitiontext.review.PlaceholderFragment.ARG_SECTION_NUMBER).toString()
            var q=resources.getIdentifier(img,"drawable", context?.packageName)
            rootView.image_vv.setImageResource(q)
            return rootView
        }
